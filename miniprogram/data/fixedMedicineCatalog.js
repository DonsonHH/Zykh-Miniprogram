...
const FIXED_MEDICINES = Object.freeze([
  ...
  },
  {
    ...
    displayOrder: 2,
    tags: ["发热", "疼痛", "解热镇痛"],
    contraindications: ["既往胃溃疡或消化道出血风险者慎用", "对非甾体抗炎药过敏禁用"],
    safetyNote: "胃溃疡、消化道出血或肾功能异常人群不得自行使用。",
    unit: "盒",
    isOtc: true,
  },
  {
  ...
  },
  {
    ...
    displayOrder: 9,
    tags: ["急性腹泻", "肠胃对症"],
    contraindications: ["肠梗阻或不明原因腹痛者慎用", "与其他口服药需错开时间"],
    safetyNote: "用于腹泻对症处理，持续腹泻、发热或便血应及时就医。",
    unit: "盒",
    isOtc: true,
  },
  {
